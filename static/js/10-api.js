...
const API_ENDPOINTS = [
  ...
  ["GET", "/api/services", "services_view", "systemd units list (admin)"],
  ["GET", "/api/services/{name}/logs", "services_view", "journal of a unit (admin)"],
  ["POST", "/api/services/{name}/{action}", "services_control", "systemctl start/stop/restart a unit (admin, runs as root)"],
  ...
  ["GET", "/api/files/download?path=", "files", "download file (forced attachment)"],
  ["GET", "/api/files/preview?path=", "files", "inline preview of passive media (415 for html/svg/js)"],
